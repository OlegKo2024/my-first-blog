...
SECRET_KEY = 'django-insecure-7w1t#jwvhl_7e-thwx8ys%r2!3+9#kyj3gh(eixhi(igu9#vof'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['localhost', '127.0.0.1', '.pythonanywhere.com']   # был ALLOWED_HOSTS = []
# When DEBUG is True and ALLOWED_HOSTS is empty, the host is validated against ['localhost', '127.0.0.1', '[::1]'].
# This won't match our hostname on PythonAnywhere once we deploy the application > we will change the following setting:
